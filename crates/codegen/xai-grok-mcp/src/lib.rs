...
//!    and a transitive ecosystem (`oauth2`, `xai-grok-tools`, ...) also pinned
//!    to 0.12. Bumping every crate to 0.13 to satisfy `rmcp` triggers a cascade
//!    of adapter and cross-version test breakage when a crate carries both
//!    versions under a renamed `package = "reqwest"` alias.
