...
fn reinstall_hint(installer: &str) -> String {
    match installer {
        "gh-release" => "Please reinstall via GitHub Releases:\n  gh release download --repo VodTinker/anime-build --pattern 'anibuild-*' --output anibuild && chmod +x anibuild".to_string(),
...
pub async fn run_update(
    ...
    if let Some(version) = pinned_version {
        ...
        eprintln!("  ✓ anibuild v{} installed successfully!", version);
        eprintln!("  Please restart Anibuild.");
    ...
    refresh_deployment_config().await;
    eprintln!("  ✓ anibuild v{} installed successfully!", target_version);
